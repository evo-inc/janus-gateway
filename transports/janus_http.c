	...
	if(!secure) {
		...
		if(!interface && !ip) {
			...
			daemon = MHD_start_daemon(
				MHD_USE_AUTO_INTERNAL_THREAD | MHD_USE_AUTO | MHD_USE_SUSPEND_RESUME | MHD_USE_DUAL_STACK | MHD_USE_ERROR_LOG,
				port,
			...
			JANUS_LOG(LOG_VERB, "Binding to %s '%s' for the %s API %s webserver\n",
				...
				admin ? "Admin" : "Janus", secure ? "HTTPS" : "HTTP");
			daemon = MHD_start_daemon(
				MHD_USE_AUTO_INTERNAL_THREAD | MHD_USE_AUTO | MHD_USE_SUSPEND_RESUME | (ipv6 ? MHD_USE_IPv6 : 0) | MHD_USE_ERROR_LOG,
				port,
				admin ? janus_http_admin_client_connect : janus_http_client_connect,
				NULL,
				admin ? &janus_http_admin_handler : &janus_http_handler,
		...
		if(!interface && !ip) {
			...
			JANUS_LOG(LOG_VERB, "Binding to all interfaces for the %s API %s webserver\n",
				admin ? "Admin" : "Janus", secure ? "HTTPS" : "HTTP");
			daemon = MHD_start_daemon(
				MHD_USE_SSL | MHD_USE_AUTO_INTERNAL_THREAD | MHD_USE_AUTO | MHD_USE_SUSPEND_RESUME | MHD_USE_DUAL_STACK | MHD_USE_ERROR_LOG,
				port,
				admin ? janus_http_admin_client_connect : janus_http_client_connect,
				NULL,
				admin ? &janus_http_admin_handler : &janus_http_handler,
			...
			JANUS_LOG(LOG_VERB, "Binding to %s '%s' for the %s API %s webserver\n",
				...
				admin ? "Admin" : "Janus", secure ? "HTTPS" : "HTTP");
			daemon = MHD_start_daemon(
				MHD_USE_SSL | MHD_USE_AUTO_INTERNAL_THREAD | MHD_USE_AUTO | MHD_USE_SUSPEND_RESUME | (ipv6 ? MHD_USE_IPv6 : 0) | MHD_USE_ERROR_LOG,
				port,
				admin ? janus_http_admin_client_connect : janus_http_client_connect,
				NULL,
				admin ? &janus_http_admin_handler : &janus_http_handler,
